...
class SendToActivity : AppCompatActivity() {
    var choosUserList: ListView?=null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        choosUserList=findViewById(R.id.chooseUser)
        val adapter=ArrayAdapter(this,android.R.layout.simple_list_item_1,emails)
        choosUserList?.adapter=adapter
        ...
        choosUserList?.onItemClickListener = AdapterView.OnItemClickListener { adapterView, view, i, l ->
